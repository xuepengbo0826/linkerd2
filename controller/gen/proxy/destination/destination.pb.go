...
package destination // import "github.com/runconduit/conduit/controller/gen/proxy/destination"
...
func (*Update) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_5384edd48bd14a2d, []int{0}
}
...
type AddrSet struct {
	Addrs                []*common.TcpAddress `protobuf:"bytes,1,rep,name=addrs" json:"addrs,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (*AddrSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_5384edd48bd14a2d, []int{1}
}
...
func (m *AddrSet) GetAddrs() []*common.TcpAddress {
	if m != nil {
		return m.Addrs
	}
	return nil
...
func (*WeightedAddrSet) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_5384edd48bd14a2d, []int{2}
}
...
type WeightedAddr struct {
	Addr                 *common.TcpAddress `protobuf:"bytes,1,opt,name=addr" json:"addr,omitempty"`
...
func (*WeightedAddr) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_5384edd48bd14a2d, []int{3}
}
...
func (m *WeightedAddr) GetAddr() *common.TcpAddress {
	if m != nil {
		return m.Addr
	}
	return nil
...
func (*TlsIdentity) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_5384edd48bd14a2d, []int{4}
}
...
func (*TlsIdentity_K8SPodIdentity) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_5384edd48bd14a2d, []int{4, 0}
}
...
func (*NoEndpoints) Descriptor() ([]byte, []int) {
	return fileDescriptor_destination_5384edd48bd14a2d, []int{5}
}
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "conduit.proxy.destination.WeightedAddrSet.MetricLabelsEntry")
	proto.RegisterType((*WeightedAddr)(nil), "conduit.proxy.destination.WeightedAddr")
	proto.RegisterMapType((map[string]string)(nil), "conduit.proxy.destination.WeightedAddr.MetricLabelsEntry")
...
type DestinationClient interface {
	...
	Get(ctx context.Context, in *common.Destination, opts ...grpc.CallOption) (Destination_GetClient, error)
}
...
func (c *destinationClient) Get(ctx context.Context, in *common.Destination, opts ...grpc.CallOption) (Destination_GetClient, error) {
...
type DestinationServer interface {
	// Given a destination, return all addresses in that destination as a long-
	// running stream of updates.
	Get(*common.Destination, Destination_GetServer) error
}
...
func init() {
	proto.RegisterFile("proxy/destination.proto", fileDescriptor_destination_5384edd48bd14a2d)
}

var fileDescriptor_destination_5384edd48bd14a2d = []byte{
