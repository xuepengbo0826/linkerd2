...
package tap // import "github.com/runconduit/conduit/controller/gen/proxy/tap"
...
func (*ObserveRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_6c9811afbd6c33eb, []int{0}
}
...
func (*ObserveRequest_Match) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_6c9811afbd6c33eb, []int{0, 0}
}
...
func (*ObserveRequest_Match_Seq) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_6c9811afbd6c33eb, []int{0, 0, 0}
}
...
func (*ObserveRequest_Match_Label) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_6c9811afbd6c33eb, []int{0, 0, 1}
}
...
func (*ObserveRequest_Match_Tcp) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_6c9811afbd6c33eb, []int{0, 0, 2}
}
...
func (*ObserveRequest_Match_Tcp_Netmask) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_6c9811afbd6c33eb, []int{0, 0, 2, 0}
}
...
func (m *ObserveRequest_Match_Tcp_Netmask) GetIp() *common.IPAddress {
	if m != nil {
		return m.Ip
	}
	return nil
...
func (*ObserveRequest_Match_Tcp_PortRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_6c9811afbd6c33eb, []int{0, 0, 2, 1}
}
...
func (*ObserveRequest_Match_Http) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_6c9811afbd6c33eb, []int{0, 0, 3}
}
...
type ObserveRequest_Match_Http_Scheme struct {
	Scheme *common.Scheme `protobuf:"bytes,1,opt,name=scheme,oneof"`
}
type ObserveRequest_Match_Http_Method struct {
	Method *common.HttpMethod `protobuf:"bytes,3,opt,name=method,oneof"`
}
...
func (m *ObserveRequest_Match_Http) GetScheme() *common.Scheme {
...
func (m *ObserveRequest_Match_Http) GetMethod() *common.HttpMethod {
...
func (*ObserveRequest_Match_Http_StringMatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_tap_6c9811afbd6c33eb, []int{0, 0, 3, 0}
}
...
func (x *tapObserveClient) Recv() (*common.TapEvent, error) {
...
func (x *tapObserveServer) Send(m *common.TapEvent) error {
...
func init() { proto.RegisterFile("proxy/tap.proto", fileDescriptor_tap_6c9811afbd6c33eb) }

var fileDescriptor_tap_6c9811afbd6c33eb = []byte{
