...
package tap // import "github.com/runconduit/conduit/controller/gen/controller/tap"

import proto "github.com/golang/protobuf/proto"
import fmt "fmt"
import math "math"
import common "github.com/runconduit/conduit/controller/gen/common"
import public "github.com/runconduit/conduit/controller/gen/public"
...
func (x *tapTapClient) Recv() (*common.TapEvent, error) {
...
func (x *tapTapByResourceClient) Recv() (*common.TapEvent, error) {
	m := new(common.TapEvent)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *tapTapServer) Send(m *common.TapEvent) error {
...
func (x *tapTapByResourceServer) Send(m *common.TapEvent) error {
	return x.ServerStream.SendMsg(m)
}
...
func init() { proto.RegisterFile("controller/tap.proto", fileDescriptor_tap_c2a2008ff24aff88) }

var fileDescriptor_tap_c2a2008ff24aff88 = []byte{
