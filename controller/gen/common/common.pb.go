...
package common // import "github.com/runconduit/conduit/controller/gen/common"
...
func (Protocol) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_common_df06bea0d0b535ab, []int{0}
}
...
func (HttpMethod_Registered) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_common_df06bea0d0b535ab, []int{0, 0}
}
...
func (Scheme_Registered) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_common_df06bea0d0b535ab, []int{1, 0}
}
...
func (*Scheme) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_df06bea0d0b535ab, []int{1}
}
...
func (*IPAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_df06bea0d0b535ab, []int{2}
}
...
func (*IPv6) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_df06bea0d0b535ab, []int{3}
}
...
func (*TcpAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_df06bea0d0b535ab, []int{4}
}
...
func (*Destination) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_df06bea0d0b535ab, []int{5}
}
...
func (*Eos) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_df06bea0d0b535ab, []int{6}
}
...
func (*TapEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_df06bea0d0b535ab, []int{7}
}
...
func (*TapEvent_EndpointMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_df06bea0d0b535ab, []int{7, 0}
}
...
func (*TapEvent_Http) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_df06bea0d0b535ab, []int{7, 1}
}
...
func (*TapEvent_Http_StreamId) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_df06bea0d0b535ab, []int{7, 1, 0}
}
...
func (*TapEvent_Http_RequestInit) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_df06bea0d0b535ab, []int{7, 1, 1}
}
...
func (*TapEvent_Http_ResponseInit) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_df06bea0d0b535ab, []int{7, 1, 2}
}
...
func (*TapEvent_Http_ResponseEnd) Descriptor() ([]byte, []int) {
	return fileDescriptor_common_df06bea0d0b535ab, []int{7, 1, 3}
}
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "conduit.common.TapEvent.EndpointMeta.LabelsEntry")
...
func init() { proto.RegisterFile("common.proto", fileDescriptor_common_df06bea0d0b535ab) }

var fileDescriptor_common_df06bea0d0b535ab = []byte{
